...
## Installation
Add and Install npm dependencies to Angular project
```
npm i atft three --save
```
...
Result:  
<img src="https://raw.githubusercontent.com/makimenko/files/master/angular-template-for-threejs/images/grid.gif">
